...
String liquid= JOptionPane.showInputDialog("ener a type of liquid");
...
String place= JOptionPane.showInputDialog("place");
		// The  entered by the player.
		// Hint: story below has has been written as a group of Strings joined together by + signs.
		// The story contains place holders, indicated by [** **] which you need to replace with
		// the values You will need to add more + signs to join the variables to the other parts of the story.
