...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("Reed's maze.png"));
...
int backGround = 64063;
		...
		if (started) {
			...
			//    (you will need to get the number of the END COLOR by moving the mouse over it)
					...
					if (mouseColor==15138817)  {JOptionPane.showMessageDialog(null,"YOU WON");}
